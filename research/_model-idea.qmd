...
2. Dynamic Embedded Topic Model, 
3. BERTopic
...
### 1. **Latent Semantic Analysis (LSA)**
   - **Latent Semantic Analysis** is a method in NLP, specifically distributional semantics,that creates a collection of ideas associated with the documents and terms, to analyze relationships between a set
of documents and the terms they contain. 
...
### 3. **BERTopic** (Bidirectional Encoder Representation Transformer)
   - **BERTopic** is a `Python` library that applies topic modeling using BERT, a powerful and easy-to-use library for intelligent topic modeling.
