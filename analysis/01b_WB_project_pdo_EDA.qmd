...
my_pretty_theme <- theme_minimal(base_family = "roboto_condensed", base_size = 12) +
  theme(panel.grid.minor = element_blank(),
        ...
        plot.subtitle = element_text(face = "plain", size = rel(1.5), color = "#A6A6A6"),
...
A more evolved way to look at the data is to use the KWIC (Key Word In Context) method. This method allows us to see the context in which a word appears in the text. 
...
out_dir_tab <- fs::path("./analysis/output/tables")
out_dir_tab
outputs_bigrams2  %>%
