...
library(stringr) # Simple, Consistent Wrappers for Common String and Regular Expression Operations
...
#| echo: false
# save for later
saveRDS(ndist_pdo, here("data" , "derived_data", "ndist_pdo.rds")) # 9914 pdo
saveRDS(duplicates, here("data" , "derived_data", "duplicates.rds")) # 2461 obs
saveRDS(count_dp, here("data" , "derived_data", "count_dp.rds")) # 1097 obs
```
...
1. [Only the 1st time]
```{r}
# # no need to repeat if you have already tagged the data
# 
