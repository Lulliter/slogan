...
Seeking some more meaningful *tokens*, I looked into the frequency of specific **sector terms** in the PDO text data. To better capture the concept of "sector", I created a **broad SECTOR variable** to encompass all relevant words in a broader definition. 
...
@fig-agr consolidated a sector that is quite broadly defined (**AGRICULTURE, FORESTRY, FISHING**) with the highest peak in 2010, two years after the publication of the WDR on **"Agriculture for Development"**.
...
@fig-climate, tracking frequency of **CLIMATE** terms, shows the highest peak in 2010, aligned the publication of the WDR on **"Development and Climate Change"** in 2010.
