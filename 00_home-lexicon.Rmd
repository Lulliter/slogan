...
## Slogan
????? urlo di guerra - da raccolta simbolica di idee chiave diventa sempre piu una dottrina. 

# At the core of reduction 
Capita che venga trasmesso come riduzione dell'originale (es «orandum est ut sit mens sana in corpore sano» (Sat., X, 356) [@garbini_uscire_2003]

In alcuni casi la deviazione del significato si evidenzia mediante la soppressione pura e semplice del termine (1984): in tali casi dunque l’analisi non insiste sull’aspetto riduzionista.bLe deviazioni, laddove presenti, sono dettate soprattutto da intenti ideologici, ossia dalla sovrapposizione di una griglia interpretativa con maglie piuttosto rigide sui dati oggettivi della realtà. L’effetto della sovrapposizione di questa griglia interpretativa chiamata ideologia risulta in tal modo una riduzione del campo percettivo ed interpretativo della realtà. Per questa ragione le deviazioni semantiche sono state denominate ‘riduzionismi’.
